...
License  : MIT
Requires: libebur128-filemap = %{version}-%{release}
...
%package filemap
Summary: filemap components for the libebur128 package.
Group: Default

%description filemap
filemap components for the libebur128 package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644263438
mkdir -p clr-build
pushd clr-build
...
%files filemap
%defattr(-,root,root,-)
/usr/share/clear/filemap/filemap-libebur128
